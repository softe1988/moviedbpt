...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { bio: @actor.bio, description: @actor.description, genre_id: @actor.genre_id, name: @actor.name }
    end
  ...
  test "should update actor" do
    patch :update, id: @actor, actor: { bio: @actor.bio, description: @actor.description, genre_id: @actor.genre_id, name: @actor.name }
    assert_redirected_to actor_path(assigns(:actor))
  end
